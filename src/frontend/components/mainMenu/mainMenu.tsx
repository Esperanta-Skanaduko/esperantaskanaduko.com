  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <MenuBox text="Twitter" link="https://twitter.com/EsperantaScan" />
        <MenuBox text="Donaci" link='https://www.paypal.com/donate?business=FSQHDN6NA2AJA&item_name=financado+por+Esperanta+Skanaduko&currency_code=USD' />
